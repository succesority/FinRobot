...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen w-full flex overflow-hidden bg-[#0a0a0a] text-white relative">
      ...
      <div className="hidden lg:flex w-[70%] relative items-center justify-center overflow-hidden z-10">
        ...
        <div className="absolute bottom-16 left-8 right-8 z-20 p-8 select-none pointer-events-none">
          <div className="h-12 relative overflow-hidden mb-3">
            <AnimatePresence mode="wait">
              <motion.h2
                ...
                className="text-4xl font-bold text-white absolute w-full"
              >
          ...
          <p className="text-slate-400 text-base max-w-xl">
            Generate professional equity research reports with financial analysis, valuation models, and risk assessment
          </p>
        </div>
      ...
      <div className="w-full lg:w-[30%] flex flex-col items-center justify-center relative z-20">
        ...
        <div className="w-full max-w-md mx-auto p-8 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 shadow-2xl relative overflow-hidden ring-1 ring-white/5">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="space-y-2">
              ...
              <h2 className="text-2xl font-bold text-white tracking-tight">Secure Your Spot</h2>
              <p className="text-sm text-slate-400">Join the whitelist to get your exclusive access code for the next generation of equity research.</p>
            </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="halo-input-wrapper group">
                    <input
                      type="text"
                      required
                      className="halo-input block w-full rounded-lg px-4 py-3 text-white placeholder-slate-500 text-sm focus:ring-0 bg-white/[0.03] group-focus-within:bg-white/[0.08] border border-white/5 focus:border-blue-500/50 transition-all duration-300"
            ...
            <div className="pt-6 border-t border-white/5 flex items-center justify-center gap-6">
              <motion.a
                href="https://github.com/blackdragonspear62/FinRobot.git"
                target="_blank"
              ...
              <motion.a
                href="https://x.com/finnrobot9652"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
